 ...
 * Body: { "prendas": [{"uniformeId": 1, "cantidad": 50}, {"uniformeId": 2,
 * "cantidad": 30}] }
 *
...
public class CalculadoraController {
        ...
        @Operation(summary = "Calcular pedido — múltiples prendas", description = """
        ...
        public ResponseEntity<ApiResponse<CalculadoraDTO.PedidoResponse>> calcularPedido(
                ...
                if (!tienePrendas && !tieneColegio) {
                        return ResponseEntity.badRequest().body(ApiResponse.<CalculadoraDTO.PedidoResponse>error(
